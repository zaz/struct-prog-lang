...
TBD: logical_expression = logical_term { "||" logical_term }
TBD: logical_term = logical_factor {"&&" logical_factor}
TBD: logical_factor = relational_expression | "!" logical_factor
TBD: expression = logical_expression
term = factor { ("*" | "/") factor }
...
def parse_assignment(tokens):
    ...
    expression, tokens = parse_relational_expression(tokens[1:])
